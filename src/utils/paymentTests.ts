...
export const runPaymentTests = async () => {
  try {
    ...
    return {
      ...
      results: [],
      summary:
        "Test suite failed with an unexpected error: " +
 ...
 */
async function testCreatePaymentIntent(): Promise<TestResult> {
  try {
 ...
 */
async function testFetchUserMinutes(): Promise<TestResult> {
  try {
 ...
 */
async function testUpdateUserMinutes(): Promise<TestResult> {
  try {
    ...
    // First, add minutes
    const addResult = await supabase.functions.invoke(
      "supabase-functions-user-minutes",
      {
    ...
    const useResult = await supabase.functions.invoke(
      "supabase-functions-user-minutes",
      {
 ...
 */
async function testWebhookHandler(): Promise<TestResult> {
  try {
