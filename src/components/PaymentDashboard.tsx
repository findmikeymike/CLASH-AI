      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Monitor and test the payment system and token tracking functionality
          </p>
        </div>
        ...
        >
          <TabsList className="bg-gray-900 border border-gray-800">
            ...
            <TabsTrigger
              value="tests"
              className={
                activeTab === "tests" ? "data-[state=active]:bg-purple-600" : ""
              }
            >
...
4. External Services:
   ...
   - ElevenLabs API: Voice synthesis (token consumption)`}
                  </pre>
                </div>
              </CardContent>
            </Card>
